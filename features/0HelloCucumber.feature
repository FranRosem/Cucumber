Feature: Showcase the simplest possible Cucumber scenario
  ...
  Scenario: Cutting vegetables Wrong long
    Given a cucumber that is 40 cm long
    When I cut it in halves
    Then I have two cucumbers
    And both are 15 cm long

  Scenario: Cutting big vegetables long
    Given a cucumber that is 100 cm long
    When I cut it in halves
    Then I have two cucumbers
    And both are 50 cm long
